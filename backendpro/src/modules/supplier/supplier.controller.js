...
class SupplierController {
  ...
  async uploadCampaignVideo(req, res) {
    try {
      ...
      console.log('[Upload Video] Fichier reçu:', req.file.originalname, '-> Cloudinary:', req.file.path);
  ...
  async createProduct(req, res) {
    try {
      ...
      const result = await db.query(
        `INSERT INTO products (supplier_id, name, price, stock_quantity, description, category_id, main_image_url, is_active)
         VALUES ($1, $2, $3, $4, $5, $6, $7, true) RETURNING *`,
        [supplierId, name, price, stock_quantity, description, category_id, main_image_url]
      );
