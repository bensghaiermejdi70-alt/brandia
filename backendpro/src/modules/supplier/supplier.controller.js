// ============================================
// SUPPLIER CONTROLLER - v6.0 PRODUCTION READY
// Corrections: Transactions, Validation uploads, Mapping erreurs PostgreSQL, Exports corrects
// ============================================
...
// Export des méthodes DU CONTRÔLEUR (avec .bind pour garder le contexte 'this')
...
console.log('[Supplier Controller] ✅ Toutes les méthodes exportées avec .bind()');